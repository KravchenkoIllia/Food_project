...
function cards() {
    ...
    (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getContent)('http://localhost:3000/menu')
        .then(data => {
...
function sliders({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', (e) => {
            ...
            slideIndex = slideTo;
            offset = deleteNotNum(width) * (slideTo - 1);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('.timer', '2022-12-12');
